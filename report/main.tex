...
colorinlistoftodos
]{todonotes} % Useful to put TODO side notes
...
filecolor=black,
linkcolor=Turquoise4, %DeepSkyBlue4!50!black,
urlcolor=RoyalBlue3,
anchorcolor=RoyalBlue3
}
\usepackage[capitalise,noabbrev]{cleveref} % smart, capitalised cross-references
\usepackage[
acronym,
toc,
nopostdot,
...
\newcommand{\todoparagraph}[1]{%
	\todo[color=yellow!40,bordercolor=yellow!40,inline,caption={}]{#1}}
...
\todototoc
{\hypersetup{colorlinks=false,linkbordercolor=red,linkcolor=black}
\footnotesize
\listoftodos %TODO remove this!
}
