...
\usepackage[acronym,toc]{glossaries} % Acronyms lists
...
%                            Title page
% **************************************************************** %
\title{\vspace{1cm}Thesis Title}
\subtitle{Thesis subtitle\vspace{8cm}}

\author{David Martínez Rodríguez (\footnotesize\texttt{davidmr@kth.se})}
\affil{MSc Student, KTH}

	% Hijacked \date command to add course information
\date{
	\textsc{MJXXXX MSc Thesis}\\
  	\textsc{Division of Industrial Ecology, SEED, ABE, KTH}\\
	\textsc{Spring 2017}\\[0.5cm]
	\today
}
